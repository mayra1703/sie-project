...
<body>
    ...
    <div class='flex flex-col m-2'>
        ...
        <div class='flex items-center justify-center'>
            <a href="{{ route('login') }}" class="flex flex-col items-center justify-center m-4 bg-dark-blue border border-dark-blue rounded-lg shadow w-52 hover:bg-gold hover:border-gold">

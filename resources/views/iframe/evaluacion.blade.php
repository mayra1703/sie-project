...
<body>
    <div class="flex justify-between py-4 px-5 bg-white rounded-md">
        <div class="min-w-0 flex-1">
            <h2 class="text-2xl font-bold leading-7 text-dark-blue sm:truncate sm:text-3xl sm:tracking-tight pb-2">Evaluacion Docente</h2>
    ...
    <div class="w-screen m-2 p-2 ">
        <ul role="list" class="divide-y divide-gray-100">
            <li class="flex justify-between py-4 px-5 bg-white rounded-md mt-2 mb-2">
                ...
                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                    ...
                    <div class="mt-1 flex items-center gap-x-1.5">
                        ...
                        <p class="mt-1 text-xs leading-5 text-gray-500">Realizada <time datetime="2023-01-23T13:23Z">3h ago</time></p>
                    </div>
                </div>
            </li>
            <li class="flex justify-between py-4 px-5 bg-white rounded-md mt-2 mb-2">
            ...
            <li class="flex justify-between py-4 px-5 bg-white rounded-md mt-2 mb-2">
                ...
                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                    ...
                    <div class="mt-1 flex items-center gap-x-1.5">
                        ...
                        <p class="text-xs leading-5 text-gray-500">Pendiente</p>
                    </div>
                </div>
            </li>
            <li class="flex justify-between py-4 px-5 bg-white rounded-md mt-2 mb-2">
